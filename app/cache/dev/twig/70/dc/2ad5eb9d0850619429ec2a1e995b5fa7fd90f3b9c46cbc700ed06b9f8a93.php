...
/* FranbellaAdminBundle:Agenda:index.html.twig */
class __TwigTemplate_70dc2ad5eb9d0850619429ec2a1e995b5fa7fd90f3b9c46cbc700ed06b9f8a93 extends Twig_Template
{
    ...
    public function block_interno($context, array $blocks = array())
    {
        ...
        echo "                
                ";
        // line 17
        if (($this->getAttribute((isset($context["evento"]) ? $context["evento"] : $this->getContext($context, "evento")), "id") > 0)) {
            // line 18
            echo "                <br />
                <p><a href=\"";
            // line 19
            ...
            // line 21
            echo twig_escape_filter($this->env, $this->env->getExtension('liip_imagine')->filter(("uploads/evento/" . $this->getAttribute((isset($context["evento"]) ? $context["evento"] : $this->getContext($context, "evento")), "capa")), "my_thumb"), "html", null, true);
            echo "\" />
                ";
        }
        // line 23
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "flashbag"), "get", array(0 => "resposta-evento"), "method"));
        ...
        echo "                
            ...
            <div class=\"caixa-registros\">
                <h4><strong>Eventos Cadastrados</strong></h4>
                ";
        // line 33
        $context['_parent'] = (array) $context;
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["evento"]) {
            ...
            echo " 
                    <span style=\"padding-left: 10px\">
                        <a href=\"";
            // line 37
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("franbella_admin_agenda_home", array("id_evento" => $this->getAttribute((isset($context["evento"]) ? $context["evento"] : $this->getContext($context, "evento")), "id"))), "html", null, true);
            echo "\">Editar</a> | 
                        <a href=\"";
            // line 38
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("franbella_admin_agenda_exclui", array("id_evento" => $this->getAttribute((isset($context["evento"]) ? $context["evento"] : $this->getContext($context, "evento")), "id"))), "html", null, true);
            echo "\">Excluir</a> |
                        <a href=\"";
            // line 39
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("franbella_admin_agenda_fotos", array("id_evento" => $this->getAttribute((isset($context["evento"]) ? $context["evento"] : $this->getContext($context, "evento")), "id"))), "html", null, true);
            echo "\">Gerenciar Fotos</a>
                    </span>
                </p>
                ";
        }
...
";
    ...
    {
        // line 4
        echo "    <h3 class=\"titulo-pagina-admin\">Agenda</h3>
";
    }
    ...
    public function block_conteudoAdministracao($context, array $blocks = array())
    {
        ...
        echo "                    <form name=\"cadastra-distribuidor\" id=\"cadastra-distribuidor\" 
                          action=\"";
        // line 11
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("franbella_admin_agenda_cadastra", array("id_evento" => $this->getAttribute((isset($context["evento"]) ? $context["evento"] : $this->getContext($context, "evento")), "id"))), "html", null, true);
        echo "\" method=\"POST\" ";
...
";
    ...
    {
        return "FranbellaAdminBundle:Agenda:index.html.twig";
    }
