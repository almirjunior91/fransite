...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bfos_brasil.form.type.cidade_choice' => 'getBfosBrasil_Form_Type_CidadeChoiceService',
            'bfos_brasil.form_type.ajax_choice' => 'getBfosBrasil_FormType_AjaxChoiceService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $c = new \Assetic\Cache\ConfigCache('C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/assetic/config');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/xampp2/htdocs/FranbellaNovo/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/xampp2/htdocs/FranbellaNovo/app/Resources/views', '/\\.[^.]+\\.php$/'), 'php');
    ...
    /**
     * Gets the 'bfos_brasil.form.type.cidade_choice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return BFOS\BrasilBundle\Doctrine\Form\Type\CidadeChoiceType A BFOS\BrasilBundle\Doctrine\Form\Type\CidadeChoiceType instance.
     */
    protected function getBfosBrasil_Form_Type_CidadeChoiceService()
    {
        return $this->services['bfos_brasil.form.type.cidade_choice'] = new \BFOS\BrasilBundle\Doctrine\Form\Type\CidadeChoiceType($this->get('doctrine'));
    }

    /**
     * Gets the 'bfos_brasil.form_type.ajax_choice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return BFOS\BrasilBundle\Doctrine\Form\Type\CidadeEntityType A BFOS\BrasilBundle\Doctrine\Form\Type\CidadeEntityType instance.
     */
    protected function getBfosBrasil_FormType_AjaxChoiceService()
    {
        return $this->services['bfos_brasil.form_type.ajax_choice'] = new \BFOS\BrasilBundle\Doctrine\Form\Type\CidadeEntityType($this);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp2/htdocs/FranbellaNovo/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'franbella', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_a489fbda58715268edd158c9abd72d64');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_a489fbda58715268edd158c9abd72d64');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_a489fbda58715268edd158c9abd72d64');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\xampp2\\htdocs\\FranbellaNovo\\src\\Franbella\\Bundle\\SiteBundle\\Entity', 1 => 'C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\brazilianfriendsofsymfony\\brasil-bundle\\BFOS\\BrasilBundle\\Entity', 2 => 'C:\\xampp2\\htdocs\\FranbellaNovo\\src\\Franbella\\Bundle\\AdminBundle\\Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Franbella\\Bundle\\SiteBundle\\Entity');
        $f->addDriver($e, 'BFOS\\BrasilBundle\\Entity');
        $f->addDriver($e, 'Franbella\\Bundle\\AdminBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('FranbellaSiteBundle' => 'Franbella\\Bundle\\SiteBundle\\Entity', 'BFOSBrasilBundle' => 'BFOS\\BrasilBundle\\Entity', 'FranbellaAdminBundle' => 'Franbella\\Bundle\\AdminBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp2/htdocs/FranbellaNovo/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'eeee2f7be844ad312f7ffdce6079cc67');
    }
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('form' => 'form.type.form', 'birthday' => 'form.type.birthday', 'checkbox' => 'form.type.checkbox', 'choice' => 'form.type.choice', 'collection' => 'form.type.collection', 'country' => 'form.type.country', 'date' => 'form.type.date', 'datetime' => 'form.type.datetime', 'email' => 'form.type.email', 'file' => 'form.type.file', 'hidden' => 'form.type.hidden', 'integer' => 'form.type.integer', 'language' => 'form.type.language', 'locale' => 'form.type.locale', 'money' => 'form.type.money', 'number' => 'form.type.number', 'password' => 'form.type.password', 'percent' => 'form.type.percent', 'radio' => 'form.type.radio', 'repeated' => 'form.type.repeated', 'search' => 'form.type.search', 'textarea' => 'form.type.textarea', 'text' => 'form.type.text', 'time' => 'form.type.time', 'timezone' => 'form.type.timezone', 'url' => 'form.type.url', 'button' => 'form.type.button', 'submit' => 'form.type.submit', 'reset' => 'form.type.reset', 'currency' => 'form.type.currency', 'entity' => 'form.type.entity', 'bfos_brasil_cidade_entity' => 'bfos_brasil.form_type.ajax_choice', 'bfos_cidade_choice' => 'bfos_brasil.form.type.cidade_choice', 'liip_imagine_image' => 'liip_imagine.form.type.image'), array('form' => array(0 => 'form.type_extension.form.http_foundation', 1 => 'form.type_extension.form.validator', 2 => 'form.type_extension.csrf'), 'repeated' => array(0 => 'form.type_extension.repeated.validator'), 'submit' => array(0 => 'form.type_extension.submit.validator')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.doctrine'))), $this->get('form.resolved_type_factory'));
    }
    ...
    {
        return $this->services['liip_imagine.binary.loader.default'] = new \Liip\ImagineBundle\Binary\Loader\FileSystemLoader($this->get('liip_imagine.mime_type_guesser'), $this->get('liip_imagine.extension_guesser'), 'C:/xampp2/htdocs/FranbellaNovo/app/../web');
    }
    ...
    {
        return $this->services['liip_imagine.cache.resolver.default'] = new \Liip\ImagineBundle\Imagine\Cache\Resolver\WebPathResolver($this->get('filesystem'), $this->get('router.request_context'), 'C:/xampp2/htdocs/FranbellaNovo/app/../web', 'media/cache/resolve');
    }
    ...
    {
        return $this->services['liip_imagine.cache.signer'] = new \Liip\ImagineBundle\Imagine\Cache\Signer('eeee2f7be844ad312f7ffdce6079cc67');
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('cache' => array('quality' => 100, 'cache' => NULL, 'data_loader' => NULL, 'filters' => array()), 'my_thumb' => array('quality' => 75, 'filters' => array('thumbnail' => array('size' => array(0 => 240, 1 => 180), 'mode' => 'inset')), 'cache' => NULL, 'data_loader' => NULL), 'my_thumb_dist' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 120, 1 => 90), 'mode' => 'inset')), 'cache' => NULL, 'data_loader' => NULL)));
    }
    ...
    {
        return $this->services['liip_imagine.filter.loader.paste'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader($this->get('liip_imagine'), 'C:/xampp2/htdocs/FranbellaNovo/app');
    }
    ...
    {
        return $this->services['liip_imagine.filter.loader.watermark'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\WatermarkFilterLoader($this->get('liip_imagine'), 'C:/xampp2/htdocs/FranbellaNovo/app');
    }
    ...
    {
        $this->services['locale_listener'] = $instance = new \Symfony\Component\HttpKernel\EventListener\LocaleListener('pt', $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp2/htdocs/FranbellaNovo/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp2/htdocs/FranbellaNovo/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/sessions');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('almir@valeservicefarma.com.br');
        $a->setPassword('almir123');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('smtp.valeservicefarma.com.br');
        $instance->setPort(25);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp2/htdocs/FranbellaNovo/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp2/htdocs/FranbellaNovo/app', 'UTF-8'));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\RoutingExtension($this->get('router')));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\YamlExtension());
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\HttpKernelExtension($this->get('fragment.handler')));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'BFOSBrasilBundle:Form:form_div_layout.html.twig', 2 => 'LiipImagineBundle:Form:form_div_layout.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\src\\Franbella\\Bundle\\SiteBundle/Resources/views', 'FranbellaSite');
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\brazilianfriendsofsymfony\\brasil-bundle\\BFOS\\BrasilBundle/Resources/views', 'BFOSBrasil');
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\src\\Franbella\\Bundle\\AdminBundle/Resources/views', 'FranbellaAdmin');
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\liip\\imagine-bundle\\Liip\\ImagineBundle/Resources/views', 'LiipImagine');
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/xampp2/htdocs/FranbellaNovo/app/Resources/views');
        $instance->addPath('C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('eeee2f7be844ad312f7ffdce6079cc67');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp2/htdocs/FranbellaNovo/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp2/htdocs/FranbellaNovo/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp2/htdocs/FranbellaNovo/app/logs',
            'kernel.bundles' => array(
                ...
                'FranbellaSiteBundle' => 'Franbella\\Bundle\\SiteBundle\\FranbellaSiteBundle',
                'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle',
                'BFOSBrasilBundle' => 'BFOS\\BrasilBundle\\BFOSBrasilBundle',
                'FranbellaAdminBundle' => 'Franbella\\Bundle\\AdminBundle\\FranbellaAdminBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'franbella',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.valeservicefarma.com.br',
            'mailer_user' => 'almir@valeservicefarma.com.br',
            'mailer_password' => 'almir123',
            'auth_mode' => 'login',
            'port' => 587,
            'encryption' => 'tls',
            'locale' => 'pt',
            'secret' => 'eeee2f7be844ad312f7ffdce6079cc67',
            ...
            'debug.container.dump' => 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'eeee2f7be844ad312f7ffdce6079cc67',
            ...
            'session.save_path' => 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp2\\htdocs\\FranbellaNovo\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/assetic/routing.yml',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'BFOSBrasilBundle:Form:form_div_layout.html.twig',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.valeservicefarma.com.br',
            'swiftmailer.mailer.default.transport.smtp.username' => 'almir@valeservicefarma.com.br',
            'swiftmailer.mailer.default.transport.smtp.password' => 'almir123',
            'swiftmailer.mailer.default.transport.smtp.auth_mode' => NULL,
            'swiftmailer.mailer.default.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.default.transport.smtp.source_ip' => NULL,
            'swiftmailer.spool.default.memory.path' => 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp2/htdocs/FranbellaNovo/app/../web',
            'assetic.write_to' => 'C:/xampp2/htdocs/FranbellaNovo/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp2/htdocs/FranbellaNovo/app/cache/dev/doctrine/orm/Proxies',
            ...
            'bfos_brasil.form_type.bfos_brasil_cidade_entity.class' => 'BFOS\\BrasilBundle\\Doctrine\\Form\\Type\\CidadeEntityType',
            'bfos_brasil.form.type.cidade_choice.class' => 'BFOS\\BrasilBundle\\Doctrine\\Form\\Type\\CidadeChoiceType',
