...
namespace Franbella\Bundle\SiteBundle\Tests\Controller;
...
class EstadoControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'franbella_bundle_sitebundle_estadotype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'franbella_bundle_sitebundle_estadotype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
